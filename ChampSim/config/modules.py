...
def get_pref_data(module_name, is_instruction_cache=False):
    return data_getter('ipref' if is_instruction_cache else 'pref', module_name, ('prefetcher_initialize', 'prefetcher_cache_operate', 'prefetcher_branch_operate', 'prefetcher_cache_fill', 'prefetcher_cache_eviction', 'prefetcher_cycle_operate', 'prefetcher_final_stats'))
...
def get_pref_lines(pref_data):
    ...
    pref_nonbranch_variant_data = [
        ...
        ('prefetcher_cache_eviction', (('uint64_t', 'addr'), ('uint64_t', 'paddr'))),
