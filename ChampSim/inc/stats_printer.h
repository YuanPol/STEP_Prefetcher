...
public:
    ...
    void print(CACHE::NonTranslatingQueues::stats_type);
...
class json_printer {
    ...
    void print(DRAM_CHANNEL::stats_type);
    void print(CACHE::NonTranslatingQueues::stats_type);
    void print(CACHE::stats_type cache_stats, CACHE::NonTranslatingQueues::stats_type cache_queue_stats);
    ...
    void print(std::vector<CACHE::NonTranslatingQueues::stats_type> stats_list);
    void print(std::vector<CACHE::stats_type> cache_stats_list, std::vector<CACHE::NonTranslatingQueues::stats_type> cache_queue_stats_list);
